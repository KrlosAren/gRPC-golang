...
type TestServiceClient interface {
	...
	SetEnrollStudents(ctx context.Context, opts ...grpc.CallOption) (TestService_SetEnrollStudentsClient, error)
...
func (c *testServiceClient) SetEnrollStudents(ctx context.Context, opts ...grpc.CallOption) (TestService_SetEnrollStudentsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], "/test.TestService/SetEnrollStudents", opts...)
	if err != nil {
		return nil, err
	}
	x := &testServiceSetEnrollStudentsClient{stream}
	return x, nil
}

type TestService_SetEnrollStudentsClient interface {
	Send(*EnrollmentRequest) error
	CloseAndRecv() (*SetQuestionResponse, error)
	grpc.ClientStream
}

type testServiceSetEnrollStudentsClient struct {
	grpc.ClientStream
}

func (x *testServiceSetEnrollStudentsClient) Send(m *EnrollmentRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *testServiceSetEnrollStudentsClient) CloseAndRecv() (*SetQuestionResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(SetQuestionResponse)
...
func (x *testServiceGetStudentsPerTestClient) Recv() (*studentpbf.Student, error) {
	m := new(studentpbf.Student)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type TestServiceServer interface {
	...
	SetEnrollStudents(TestService_SetEnrollStudentsServer) error
...
func (UnimplementedTestServiceServer) SetEnrollStudents(TestService_SetEnrollStudentsServer) error {
...
func _TestService_SetEnrollStudents_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestServiceServer).SetEnrollStudents(&testServiceSetEnrollStudentsServer{stream})
}

type TestService_SetEnrollStudentsServer interface {
	SendAndClose(*SetQuestionResponse) error
	Recv() (*EnrollmentRequest, error)
	grpc.ServerStream
}

type testServiceSetEnrollStudentsServer struct {
	grpc.ServerStream
}

func (x *testServiceSetEnrollStudentsServer) SendAndClose(m *SetQuestionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *testServiceSetEnrollStudentsServer) Recv() (*EnrollmentRequest, error) {
...
func (x *testServiceGetStudentsPerTestServer) Send(m *studentpbf.Student) error {
	return x.ServerStream.SendMsg(m)
}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _TestService_SetEnrollStudents_Handler,
			ClientStreams: true,
		},
		{
